...
export default function AlertService({}:Props) {
  ...
  return (
      <ButtonNew onClick={(e) => {setBlur(true); setReportPopapState(true); e.preventDefault();}} href='/' type='Default Ghost' size='m'  iconPosition='icon' className={styles.button} color='whiteBlue'>
