      ...
      <div className={styles.stickyWrapper}>
        <div className={styles.scrollWrapper}>
          ...
          <div className={cn(styles.UiscoreLogo, styles.cardHelp)}>
            ...
            ></Image>
            <h5>Free design assets</h5>
            <p>Follow us on figma to get free design assets</p>
            <ButtonNew
              href="https://www.figma.com/@uiscore"
              size="es"
            ...
            >
              ...
              >
                <path
                  d="M17.1666 10.3792L11.5416 16.2126M17.1666 10.3792L11.5416 4.5459M17.1666 10.3792L3.83325 10.3792"
                  stroke="white"
                  stroke-width="1.6"
          ...
          <ButtonNew
            href="https://uiscore.lemonsqueezy.com/buy/101c4821-3cd0-4787-900c-fad723198647?embed=1&logo=0&discount=0"
            type="Default Ghost"
          ...
          <footer className={styles.footer}>
            <div className={styles.linkWrapper}>
              <Link
                href={"https://dribbble.com/uiscore"}
              ...
              <Link
                href={"https://twitter.com/uiscore"}
                className={styles.link}
              >
                <Image
              ...
              <Link
                href={"https://www.instagram.com/uiscore.io"}
                className={styles.link}
              >
                <Image
            ...
            <p>
              © 2024 Made by Uiscore
              <br />
              <a href="mailto:libary@uiscore.io">libary@uiscore.io</a>
            </p>
          </footer>
        </div>
      </div>
