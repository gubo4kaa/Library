  ...
  return (
    <div className={styles.wrapper}>
        ...
        <div className={styles.grid}>
            <VideoCard className={styles.mainVideo} src='/video/main.mp4' title='Resource Overview' p='Now each resource has its own separate page with brief information.'></VideoCard>
