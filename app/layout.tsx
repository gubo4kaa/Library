...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "user experience design tutorials",
    ...
    "Design community forums",
    "design community discussions",
    "design forums",
    "online design communities",
    "design networking opportunities",
    "Developer resources and guides",
    "developer documentation",
    "programming guides",
    "coding resources for beginners",
    "developer community support",
    "Influencer branding tips",
    ...
    "UX design courses",
    "online learning platforms for designers",
    "Social media management tools",
  ...
  authors: [
    { name: "Uiscore" },
    { name: "Uiscore", url: "https://uiscore.io" },
  ],
  colorScheme: "light",
    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="R8Af_c8CjfDZBppwEHaUnwdybYmDm0M7DAnQmeMx35M"
        />
        <meta
          name="viewport"
